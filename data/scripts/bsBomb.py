...
class BombFactory(object):
    ...
    def __init__(self):
        ...
        self.bombModel = bs.getModel('bombSticky')
        ...
        self.regularTex = bs.getTexture('lightSoft')
        self.iceTex = bs.getTexture('egg2')
        self.stickyTex = bs.getTexture('ouyaOButton')
        self.impactTex = bs.getTexture('black')
        self.impactLitTex = bs.getTexture('black')
