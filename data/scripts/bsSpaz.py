        ...
        if isinstance(msg, bs.PickedUpMessage):
            ...
            if msg.hitType == 'punch':
                ...
                if damage >= 800 and damage <= 99999:
                    bsUtils.PopupText(u"\ue046R.I.P\ue046",color=(2,0,0),scale=1.9,position=self.node.position).autoRetain() 
                    bs.emitBGDynamics(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),count=999,spread=0.7,chunkType='metal')                   
                elif damage >= 700 and damage < 800:
                    bsUtils.PopupText(u"\ue046IMPRESSIVE\ue046",color=(2,0,0),scale=1.7,position=self.node.position).autoRetain()
                    bs.emitBGDynamics(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),count=999,spread=0.7,chunkType='splinter')
                elif damage >= 600 and damage < 700:
                    bsUtils.PopupText(u"\ue046AWESOME\ue046",color=(2,0,0),scale=1.7,position=self.node.position).autoRetain()
                    bs.emitBGDynamics(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),count=999,spread=0.7,chunkType='slime')
                elif damage >= 500 and damage < 600:
                    bsUtils.PopupText(u"\ue046WELL DONE\ue046",color=(1, 0.5, 0),scale=1.7,position=self.node.position).autoRetain()
                    bs.emitBGDynamics(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),count=999,spread=0.7,chunkType='ice')
                elif damage >= 400 and damage < 500:
                    bsUtils.PopupText(u"\ue046NICE ONE\ue046",color=(1, 0.5, 0),scale=1.7,position=self.node.position).autoRetain()                 
                    bs.emitBGDynamics(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),count=999,spread=0.7,chunkType='spark')
                elif damage >= 300 and damage < 400:
                    bsUtils.PopupText(u"\ue046PRO\ue046",color=(1, 0.5, 0),scale=1.7,position=self.node.position).autoRetain()
                elif damage >= 200 and damage < 300:
                    bsUtils.PopupText(u"\ue046GOOD!!\ue046",color=((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),scale=1.7,position=self.node.position).autoRetain()
                elif damage >= 100 and damage < 200:
                    bsUtils.PopupText(u"\ue046COOL\ue046",color=((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),scale=1.7,position=self.node.position).autoRetain()
                elif damage > 0 and damage < 100:
                    bsUtils.PopupText(u"\ue046NICE\ue046",color=((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),scale=1.7,position=self.node.position).autoRetain()
